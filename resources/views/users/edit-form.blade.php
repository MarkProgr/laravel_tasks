...
@section('content')
    <form action="{{ route('edit.user', ['localUser' => $localUser->id]) }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="lg:w-2/6 md:w-1/2 bg-gray-100 rounded-lg p-8 flex flex-col mx-auto mt-10 md:mt-0">
            ...
            <div class="relative mb-4">
                ...
                <input type="text" value="{{ $localUser->name }}" id="full-name" name="name" class="w-full text-center bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-black py-1 px-3 leading-8 transition-colors duration-200 ease-in-out
            ...
            <div class="relative mb-4">
                ...
                <input type="email" id="email" value="{{ $localUser->email }}" name="email" class="w-full text-center bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-black py-1 px-3 leading-8 transition-colors duration-200 ease-in-out
            ...
            <div class="mb-3">
                ...
                <input type="file" value="{{ $localUser->image_name }}" name="image_name" class="block w-full text-sm text-slate-500
